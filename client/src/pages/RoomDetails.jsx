        ...
        md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e) => setCheckInDate(e.target.value)}
                            ...
                            id='checkInDate' placeholder='Check-In' className='w-full rounded
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type="number" id='guests' placeholder='1' className='max-w-20
                rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none'
                            required />
                    </div>
                </div>

                <button type='submit' className='bg-primary hover:bg-primary-hull
        ...
        max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
            ...
            <div className='flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    <img src={assets.logo} alt="Host" className='h-14 w-14
